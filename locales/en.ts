export default {
  auth: {
    ...
    newPasswordMustDiffer: 'New password must be different from your previous password.',
    passwordWeak: 'Password is too weak. Please choose a stronger one.',
    ...
    resetEmailSent: 'If an account exists for this email, you will receive a password reset link shortly.',
    forgotPasswordHint: 'Enter your email. We will send you a link to set a new password.',
    resetPasswordTitle: 'Set a new password',
    resetPasswordHint: 'Choose a strong password you have not used elsewhere.',
  ...
  welcome: {
    lead: 'Omnifolio helps you track your portfolio and assets in one place—you stay in control of every decision.',
    whatTitle: 'What it does',
    bullet1: 'Shows your positions, latest prices, and allocation together.',
    bullet2: 'Supports TEFAS funds, BIST, FX, commodities, US stocks, crypto, and more.',
    bullet3: 'Your data is tied to your account; sign in on any device to access it.',
    dataTitle: 'Where is your data?',
    dataBody:
      'Your portfolio records and account data are stored in Supabase, in a space scoped to your account. The app does not provide investment advice or promise returns.',
    disclaimer:
      'This app does not provide investment advice; it is for information and tracking only. You are responsible for your own investment decisions.',
    continue: 'Continue',
  },
  tabs: {
    home: 'Home',
  ...
  settings: {
    ...
    notificationsToggleTitle: 'Receive notifications',
    ...
    deletePortfolioConfirmTitle: 'Delete portfolio?',
    deletePortfolioConfirmBody:
      'If you delete "{{name}}", all asset data under this portfolio will also be deleted. Are you sure?',
  ...
  assetEntry: {
    ...
    labelUnitCost: 'Average cost (optional)',
    labelPurchaseDateOptional: 'Purchase date (optional)',
    costDatePlaceholder: 'DD.MM.YYYY',
    invalidCostDate: 'Invalid purchase date. Use DD.MM.YYYY format.',
    openCostDatePicker: 'Pick date from calendar',
    ...
    modalNo: 'No',
    modalYes: 'Yes, remove',
    toastAddDone: 'Your transaction was added',
  ...
  home: {
    ...
    totalNetWorth: 'Your portfolio total',
    portfolioKicker: 'Omnifolio snapshot',
