export default {
  auth: {
    ...
    newPasswordMustDiffer: 'Yeni şifre, eski şifreden farklı olmalı.',
    passwordWeak: 'Şifre çok zayıf. Daha güçlü bir şifre deneyin.',
  ...
  settings: {
    ...
    notificationsToggleTitle: 'Bildirimleri al',
    ...
    save: 'Kaydet',
    cancel: 'İptal',
    cancelDeletePortfolio: 'Vazgeç',
    confirmDeletePortfolio: 'Evet, sil',
    deletePortfolioConfirmTitle: 'Portföy silinsin mi?',
    deletePortfolioConfirmBody:
      '"{{name}}" portföyünü silerseniz, bu portföy altındaki tüm varlık bilgileri de silinecek. Emin misiniz?',
  ...
  assetEntry: {
    ...
    portfolioShare: 'Portföy dağılımı',
    dailyReturn: 'Bugünkü getiri',
    ...
    averageCostUsd: 'Ortalama maliyet USD',
    usdValue: 'Birim (USD)',
    ...
    labelUnitCost: 'Ortalama maliyet (opsiyonel)',
    labelPurchaseDateOptional: 'Satın alma tarihi (opsiyonel)',
    costDatePlaceholder: 'GG.AA.YYYY',
    invalidCostDate: 'Satın alma tarihi geçersiz. GG.AA.YYYY formatında girin.',
    openCostDatePicker: 'Takvimden tarih seç',
    ...
    modalNo: 'Hayır',
    modalYes: 'Evet, sil',
    toastAddDone: 'İşleminiz eklendi',
