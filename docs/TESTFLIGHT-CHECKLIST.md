...
- Bundle Identifier `app.json` ile birebir ayni olmali (`com.gulbeyazozturk.omnifolio`).
...
|-----------------|-------------|--------|
| **Apple ID** (EAS/Apple girisi) | `sen@icloud.com` | `6761783988` (bu ASC App ID, Apple ID degil) |
| **ascAppId** (App Store Connect) | Sadece rakam: `6761783988` | E-posta veya bos |
...
$env:EXPO_ASC_APP_ID = "6761783988"
